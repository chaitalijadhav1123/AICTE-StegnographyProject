...
# Load cover image
img = cv2.imread("flower.jpg")  # Ensure this image exists in your working directory
if img is None:
...
cv2.imwrite("flowerencrypted.png" , img)
os.system("start flowerencrypted.png")  # For Windows; on macOS use 'open' and on Linux 'xdg-open'
